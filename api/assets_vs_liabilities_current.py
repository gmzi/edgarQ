...
# REQ MODEL: http://192.168.1.9:3000/api/assets_vs_liabilities_current?ticker=meli
...
def catch_all(path):
    ...
    try:
        ...
        assets_req = requests.get(
            f"https://data.sec.gov/api/xbrl/companyconcept/{newCIK}/us-gaap/AssetsCurrent.json", headers=headers)
        ...
        liabilities_req = requests.get(
            f"https://data.sec.gov/api/xbrl/companyconcept/{newCIK}/us-gaap/LiabilitiesCurrent.json", headers=headers)
